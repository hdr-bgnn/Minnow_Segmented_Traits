...
measure_stats = b.meta.measure.df.scale %>%
  ...
  dplyr::summarise(sample.size = n(),
                   ...
                   se.err.SL_bbox = sd(SL_bbox.conv, na.rm = TRUE)/sqrt(sample.size),
                   ...
                   se.err.SL_lm = sd(SL_lm.conv, na.rm = TRUE)/sqrt(sample.size),
                   ...
                   se.err.HL_bbox = sd(HL_bbox.conv, na.rm = TRUE)/sqrt(sample.size),
                   ...
                   se.err.HL_lm = sd(HL_lm.conv, na.rm = TRUE)/sqrt(sample.size),
                   ...
                   se.err.pOD_bbox = sd(pOD_bbox.conv, na.rm = TRUE)/sqrt(sample.size),
                   ...
                   se.err.pOD_lm = sd(pOD_lm.conv, na.rm = TRUE)/sqrt(sample.size),
                   ...
                   se.err.ED_bbox = sd(ED_bbox.conv, na.rm = TRUE)/sqrt(sample.size),
                   ...
                   se.err.ED_lm = sd(ED_lm.conv, na.rm = TRUE)/sqrt(sample.size),
                   ...
                   se.err.HH_lm = sd(HH_lm.conv, na.rm = TRUE)/sqrt(sample.size),
